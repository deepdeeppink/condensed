...
% initial pressure
	...
	pressure = 5e5 + zeros(size(coordinate));
	...
	J.pressureLeft = F.pressure(end);
	J.pressureRight = T.pressure(1);
	J.flow = F.velocity(end) * F.section;
